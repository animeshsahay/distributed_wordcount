...
public class WordCountTest implements Master {
    ...
    private File outputFolder = new File("/Users/animesh/StudioProject/project-2-group-18/wordCount-output");

    public WordCountTest(int workerNum, String[] filenames) throws IOException {
...
//        String[] arr = {"/Users/animesh/StudioProject/project-2-group-18/example-output/war-and-peace.txt", "/Users/animesh/StudioProject/project-2-group-18/example-output/king-james-version-bible.txt", "/Users/animesh/StudioProject/project-2-group-18/example-output/hr-wiki.txt"};
        String[] arr = {"/Users/animesh/StudioProject/project-2-group-18/src/test/resources/simple.txt", "/Users/animesh/StudioProject/project-2-group-18/src/test/resources/random.txt"};
        WordCountTest wordCountTest = new WordCountTest(1, arr);
        wordCountTest.run();
    }
     ...
     synchronized public void run(){
         ...
         File file = new File("/Users/animesh/StudioProject/project-2-group-18/wordCount-output");
         if(file.exists()) {
...
//                               Thread.sleep(2000);
         ...
         // Creating a thread for combining
    ...
    synchronized public void createWorker() throws IOException {
